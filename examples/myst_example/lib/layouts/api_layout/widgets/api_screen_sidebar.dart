...
class ApiScreenSideBar extends StatelessWidget {
  const ApiScreenSideBar({Key? key}) : super(key: key);
  ...
  Widget xsBuilder(BuildContext context) {
    ...
    return PopupMenuButton(
        ...
        PopupMenuItem(
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
              child: Column(
                children: ApiScreenSideBar.getMenus(context),
              ),
            ),
          ),
        )
      ...
      child: Card(
        child: ListTile(
          title: ApiScreenSideBar.header.title,
          leading: ApiScreenSideBar.header.leading,
    ...
    return SizedBox(
      ...
      child: Column(
        children: [
          ListTile(
              leading: ApiScreenSideBar.header.leading,
              onTap: ApiScreenSideBar.header.onTap),
          Divider(),
          Expanded(
              child: ListView(
            children: [
              ...ApiScreenSideBar.getMenus(context).map(
